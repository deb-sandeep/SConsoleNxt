...
public class AppConstants {
    ...
    public static final String IIT_PHY_SYLLABUS_NAME   = "IIT Physics" ;
    public static final String IIT_CHEM_SYLLABUS_NAME  = "IIT Chemistry" ;
    public static final String IIT_MATHS_SYLLABUS_NAME = "IIT Maths" ;
    public static final String REASONING_SYLLABUS_NAME = "Reasoning" ;
    public static final String EXAM_SYLLABUS_NAME      = "Exam" ;
